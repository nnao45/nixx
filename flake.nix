  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        e2eDeps = mkE2e "e2e-deps" ((nixx.mkTasks { name = "e2e-deps"; } {
        ...
        e2eEnv = mkE2e "e2e-env" ((nixx.mkTasks { name = "e2e-env"; } {
          env_test = nixx.task {
        ...
        e2eStrict = mkE2e "e2e-strict" ((nixx.mkTasks { name = "e2e-strict"; } {
        ...
        e2eCombo = mkE2e "e2e-combo" ((nixx.mkTasks { name = "e2e-combo"; } {
          setter = nixx.sh ''
        ...
        e2eEdge = mkE2e "e2e-edge" ((nixx.mkTasks {
          name = "e2e-edge";
        ...
        e2eCircular = mkE2e "e2e-circular" ((nixx.mkTasks { name = "e2e-circular"; } {
